...
<?php
  ...
  $log = $_SESSION[login];
  $run_pro = mysqli_query($conn, "select * from Cart where login='$log'");
  ...
  <table class="table" align = "center" >
    ...
    <tr id="info">
      ...
      <td><a href = "delete_pro_cart.php?delete_product=<?php echo $pro_id;?>"> <img id="delete" src="<?php echo PATH; ?>/delete.png" alt="delete"></a></td>
    </tr>
  <?php } ?>
  ...
  <tr>
    <td colspan ="10">
    <form action="check_out.php?login=<?php echo $log; ?>" method = "post">
...
<?php } else if($log) { ?>
  <div style="font-size:30px;font-weight:bold;"> <?php echo $log; ?>, your cart is empty! </div>
<?php } else { ?>
  <div style="font-size:30px;font-weight:bold;"> You need to login in order to see your cart </div>
<?php } ?>
